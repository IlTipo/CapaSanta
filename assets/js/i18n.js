...
window.CAPASANTA_I18N = {
  it: {
    ...
    mapPrivacy: "Aprendo la mappa il tuo indirizzo IP viene comunicato a OpenStreetMap.",
    privacyLink: "Privacy e cookie",
    backToSite: "Torna al sito",
    legalEyebrow: "Informativa",
    legalTitle: "Privacy e cookie",
    vatLabel: "P. IVA", reaLabel: "REA",
    draftWarn: "Bozza — mancano ancora {n} dati del titolare (evidenziati in giallo). Da completare prima di pubblicare il sito.",
    hoursTitle: "Orari",
  ...
  en: {
    ...
    mapPrivacy: "Opening the map discloses your IP address to OpenStreetMap.",
    privacyLink: "Privacy & cookies",
    backToSite: "Back to the site",
    legalEyebrow: "Notice",
    legalTitle: "Privacy & cookies",
    vatLabel: "VAT", reaLabel: "REA",
    draftWarn: "Draft — {n} controller details are still missing (highlighted in yellow). To be completed before the site goes live.",
  ...
  fr: {
    ...
    mapPrivacy: "L'ouverture de la carte communique votre adresse IP à OpenStreetMap.",
    privacyLink: "Confidentialité et cookies",
    backToSite: "Retour au site",
    legalEyebrow: "Politique",
    legalTitle: "Confidentialité et cookies",
    vatLabel: "TVA", reaLabel: "REA",
    draftWarn: "Brouillon — il manque encore {n} informations sur le responsable (surlignées en jaune). À compléter avant la mise en ligne.",
    hoursTitle: "Horaires",
